...
namespace DAL
{
    ...
    public sealed class SqlHelper
    {
        ...
        public static readonly string sqlconn = @"Data Source=.\SQLEXPRESS;AttachDbFilename=D:\myworkSpace\vs2008Solution\ThreeLayerDemo\DAL\Database1.mdf;Integrated Security=True;User Instance=True";
        ...
        /// 取回连接字符串
        /// </summary>
        new private static string ConnectionString
        {
            get { return System.Configuration.ConfigurationManager.ConnectionStrings["ConStr"].ToString(); }
        }
        ...
        /// <summary>
        /// 执行一个没有参数的,只返回影响行数的SQL或存储过程(ExecuteNonQuery 最外层)。
        /// </summary>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">The stored procedure name or T-SQL command</param>
        ...
        */
        ...
        /// <summary>
        /// Execute a SqlCommand (that returns a resultset and takes no parameters and no connectionstring) against the database specified in 
        /// the connection string. 
        /// 外层
        /// </summary>
        /// <remarks>
        ...
        */
        ...
        {
            object ec = ExecuteScalar(ConnectionString, commandType, commandText);
            if (ec == null)
            {
                return "";
            }
        ...
        /// This method will query the SqlHelper to discover the parameters for the 
        /// stored procedure (the first time each stored procedure is called), and assign the values based on row values.
        /// </summary>
        /// <param name="connection">A valid SqlConnection object</param>
        /// <param name="spName">The name of the stored procedure</param>
        ...
        /// <summary>
        /// Execute a stored procedure via a SqlCommand (that returns a resultset) against the SqlHelper specified in 
        /// the connection string using the dataRow column values as the stored procedure's parameters values.
        /// This method will query the SqlHelper to discover the parameters for the 
        /// stored procedure (the first time each stored procedure is called), and assign the values based on parameter order.
        /// </summary>
        ...
        /// <summary>
        /// Execute a stored procedure via a SqlCommand (that returns a 1x1 resultset) against the SqlHelper specified in 
        /// the connection string using the dataRow column values as the stored procedure's parameters values.
        /// This method will query the SqlHelper to discover the parameters for the 
        /// stored procedure (the first time each stored procedure is called), and assign the values based on parameter order.
        /// </summary>
        ...
        {
            return ExecuteNonQuery(SqlHelper.ConnectionString, CommandType.StoredProcedure, procName, (SqlParameter[])null);
        }
        ...
        {
            return ExecuteNonQuery(SqlHelper.ConnectionString, CommandType.StoredProcedure, procName, prams);
        }
        /// <summary>
        ...
        {
            reader = ExecuteReader(SqlHelper.ConnectionString, CommandType.StoredProcedure, procName, (SqlParameter[])null);
        }
        ...
        {
            reader = ExecuteReader(SqlHelper.ConnectionString, CommandType.StoredProcedure, procName, prams);
        }
        ...
        {
            ds = ExecuteDataset(SqlHelper.ConnectionString, CommandType.StoredProcedure, procName, (SqlParameter[])null);
        }
        ...
        {
            ds = ExecuteDataset(SqlHelper.ConnectionString, CommandType.StoredProcedure, procName, prams);
        }
        ...
        {
            obj = ExecuteScalar(SqlHelper.ConnectionString, CommandType.StoredProcedure, procName, (SqlParameter[])null);
        }
        ...
        {
            obj = ExecuteScalar(SqlHelper.ConnectionString, CommandType.StoredProcedure, procName, prams);
        }
        ...
        {
            xmlReader = ExecuteXmlReader(new SqlConnection(SqlHelper.ConnectionString), CommandType.StoredProcedure, procName, (SqlParameter[])null);
        }
        ...
        {
            xmlReader = ExecuteXmlReader(new SqlConnection(SqlHelper.ConnectionString), CommandType.StoredProcedure, procName, prams);
        }
    ...
    public sealed class ParamsCache
    {
        ...
        /// </summary>
        /// <remarks>
        /// This method will query the SqlHelper for this information, and then store it in a cache for future requests.
        /// </remarks>
        /// <param name="connectionString">A valid connection string for a SqlConnection</param>
        /// <param name="spName">The name of the stored procedure</param>
